...
-DUseErrorFilePath=C:/dev/docs/BrightPlan/BrightPlan_B/testing/output/ ;^
org.junit.runner.JUnitCore com.brightplan.automation.projects.yelp.YELP001_DisplaySearchDetails_JUnit > run3.txt
